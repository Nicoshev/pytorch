...
//Max ULP: 2.85
inline at::vec::Vectorized<float> bc_log(at::vec::Vectorized<float> d) {
...
//Max ULP: 1.95
inline at::vec::Vectorized<float> bc_exp(const at::vec::Vectorized<float> x_in) {
...
inline at::vec::Vectorized<float> bc_pow(at::vec::Vectorized<float> a, at::vec::Vectorized<float> b) {
  return bc_exp(bc_log(a) * b);
}

// Fallback to veclib for doubles

inline at::vec::Vectorized<double> bc_log(at::vec::Vectorized<double> d) {
  return d.log();
}

inline at::vec::Vectorized<double> bc_pow(at::vec::Vectorized<double> a, at::vec::Vectorized<double> b) {
  return a.pow(b);
}
